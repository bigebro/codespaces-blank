  ...
  return (
    <div className="w-full h-full flex-1 flex flex-col bg-[#0d1527] rounded-[2rem] border border-slate-800 overflow-hidden shadow-2xl min-h-0">
      ...
      <div className="flex-1 p-4 sm:p-6 overflow-y-auto space-y-4 min-h-0">
        ...
        {chatHistory.map((msg, i) => (
          <div key={i} className={`flex ${msg.sender === 'worker' ? 'justify-end' : 'justify-start'}`}>
            <div className={`max-w-[90%] sm:max-w-[85%] p-4 sm:p-5 rounded-2xl text-base sm:text-lg leading-relaxed ${
              msg.sender === 'worker' 
      ...
      <div className="p-4 bg-slate-900 border-t border-slate-800 flex gap-3 items-center shrink-0">
        ...
        />
        <label htmlFor="kiosk-ai-camera" className="h-16 w-16 bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 rounded-2xl cursor-pointer transition flex items-center justify-center shrink-0 shadow-md">
